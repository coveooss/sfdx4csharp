...
namespace sfdx4csharpClient
{
    ...
    /// </summary>
    public class SchemaGenerateFieldOptions : SfOptions
    {
        /// <summary>
    ...
    /// </summary>
    public class SchemaGeneratePlatformeventOptions : SfOptions
    {
        /// <summary>
        /// [Required] No description for label
        /// </summary>
    ...
    /// </summary>
    public class SchemaGenerateSobjectOptions : SfOptions
    {
        /// <summary>
        /// [Required] No description for label
        /// </summary>
    ...
    /// </summary>
    public class SchemaGenerateTabOptions : SfOptions
    {
        /// <summary>
    ...
    public class Schema : SfCommand
    {
        ...
        /// $ sf generate field --label "My Field"
        /// Specify the local path to the object's folder:
        /// $ sf generate field --label "My Field" --object force-app/main/default/objects/MyObject__c
        /// </example>
        [Command("generate field")]
        public SfResponse GenerateField(SchemaGenerateFieldOptions options)
        {
        ...
        /// $ sf generate platformevent --label "My Platform Event"
        /// </example>
        [Command("generate platformevent")]
        public SfResponse GeneratePlatformevent(SchemaGeneratePlatformeventOptions options)
        {
        ...
        /// $ sf generate sobject --label "My Object"
        /// Create a custom object and enable optional features without prompting:
        /// $ sf generate sobject --label "My Object" --use-default-features
        /// </example>
        [Command("generate sobject")]
        public SfResponse GenerateSobject(SchemaGenerateSobjectOptions options)
        {
        ...
        /// $ sf generate tab --object `MyObject__c` --icon 54 --directory force-app/main/default/tabs
        /// </example>
        [Command("generate tab")]
        public SfResponse GenerateTab(SchemaGenerateTabOptions options)
        {
