...
namespace sfdx4csharpClient
{
    ...
    /// </summary>
    public class ScannerRuleAddOptions : SfOptions
    {
        /// <summary>
    ...
    /// </summary>
    public class ScannerRuleDescribeOptions : SfOptions
    {
        /// <summary>
    ...
    /// </summary>
    public class ScannerRuleListOptions : SfOptions
    {
        /// <summary>
        /// [Optional] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] Selects rules by category. Enter multiple values as a comma-separated list.
        /// </summary>
        [SwitchName("--category")]
        public string Category { get; set; }

        /// <summary>
        /// [Optional] Deprecated. Use category instead. Selects rules by ruleset. Enter multiple values as a comma-separated list.
        /// </summary>
        [SwitchName("--ruleset")]
        public string Ruleset { get; set; }

        /// <summary>
        /// [Optional] Selects rules by language. Enter multiple values as a comma-separated list.
        /// </summary>
        [SwitchName("--language")]
        public string Language { get; set; }

        /// <summary>
        /// [Optional] Selects rules by engine. Enter multiple engines as a comma-separated list.
        /// </summary>
        [SwitchName("--engine")]
    ...
    /// </summary>
    public class ScannerRuleRemoveOptions : SfOptions
    {
        /// <summary>
        /// [Optional] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] One or more paths to remove. Specify multiple values with a comma-separated list.
        /// </summary>
        [SwitchName("--path")]
        public string Path { get; set; }
    }
    ...
    /// </summary>
    public class ScannerRunOptions : SfOptions
    {
        /// <summary>
        /// [Optional] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] One or more categories of rules to run. Specify multiple values as a comma-separated list.
        /// </summary>
        [SwitchName("--category")]
        public string Category { get; set; }

        /// <summary>
        /// [Optional] Specifies the output format for results written directly to the console.
        /// </summary>
        [SwitchName("--format")]
        public string Format { get; set; }

        /// <summary>
        /// [Optional] Writes output to a file.
        /// </summary>
        [SwitchName("--outfile")]
        public string Outfile { get; set; }

        /// <summary>
        /// [Optional] Throws an error when violations are found with equal or greater severity than the provided value. Values are 1 (high), 2 (moderate), and 3 (low). Exit code is the most severe violation. Using this flag also invokes the --normalize-severity flag.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] Provides the relative or absolute root project directories used to set the context for Graph Engine's analysis. Specify multiple values as a comma-separated list. Each project directory must be a path, not a glob. If --projectdir isn’t specified, a default value is calculated. The default value is a directory that contains all the target files.
        /// </summary>
        [SwitchName("--projectdir")]
        public string Projectdir { get; set; }

        /// <summary>
        /// [Optional] Deprecated. Use category instead. One or more rulesets to run. Specify multiple values as a comma-separated list.
        /// </summary>
        [SwitchName("--ruleset")]
        public string Ruleset { get; set; }

        /// <summary>
        /// [Optional] Specifies one or more engines to run. Submit multiple values as a comma-separated list.
        /// </summary>
        [SwitchName("--engine")]
        public string Engine { get; set; }

        /// <summary>
        /// [Optional] Specifies the source code location. Can use glob patterns. Specify multiple values as a comma-separated list. Default is ".".
        /// </summary>
        [SwitchName("--target")]
        public string Target { get; set; }

        /// <summary>
        /// [Optional] The location of the tsconfig.json file used by the eslint-typescript engine. The --tsconfig flag can’t be used with --eslintconfig flag.
        /// </summary>
        [SwitchName("--tsconfig")]
        public string Tsconfig { get; set; }

        /// <summary>
        /// [Optional] Specifies the location of eslintrc config to customize ESLint engine. The --tsconfig flag can’t be used with --eslintconfig flag.
        /// </summary>
        [SwitchName("--eslintconfig")]
        public string Eslintconfig { get; set; }

        /// <summary>
        /// [Optional] Specifies the location of the PMD rule reference XML file to customize rule selection.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] Deprecated. Overrides ESLint's default environmental variables, in JSON-formatted string.
        /// </summary>
        [SwitchName("--env")]
    ...
    /// </summary>
    public class ScannerRunDfaOptions : SfOptions
    {
        /// <summary>
        /// [Optional] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] Specifies the source code location. Use glob patterns or specify individual methods with #-syntax. Multiple values are specified as a comma-separated list. Default is ".".
        /// </summary>
        [SwitchName("--target")]
        public string Target { get; set; }

        /// <summary>
        /// [Optional] Specifies the number of rule-evaluation threads or how many entry points can be evaluated concurrently. Inherits its value from the SFGE_RULE_THREAD_COUNT environment variable, if set. The default is 4.
        /// </summary>
        [SwitchName("--rule-thread-count")]
        public string RuleThreadCount { get; set; }

        /// <summary>
        /// [Optional] Specifies the time limit for evaluating a single entry point in milliseconds. Inherits its value from the SFGE_RULE_THREAD_TIMEOUT environment variable, if set. The default is 900,000 ms or 15 minutes.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] Specifies Java Virtual Machine arguments to override system defaults while executing Salesforce Graph Engine. For multiple arguments, add them to the same string separated by space.
        /// </summary>
        [SwitchName("--sfgejvmargs")]
        public string Sfgejvmargs { get; set; }

        /// <summary>
        /// [Optional] Specifies a path expansion upper boundary to limit the complexity of code Graph Engine analyzes before failing fast. Set the value to -1 to remove any upper boundary. --pathexplimit inherits value from SFGE_PATH_EXPANSION_LIMIT env-var, if set. Its default value is derived from JVM heap space allocation.
        /// </summary>
    ...
    public class Scanner : SfCommand
    {
        /// Constructor.
        ...
        /// 	$ $ sf rule add --language apex --path "/Users/me/rules/Jar1.jar,/Users/me/rules/Jar2.jar"
        ...
        /// 	$ $ sf rule add --language apex --path "/Users/me/rules"
        /// 		Successfully added rules for apex.
        /// </example>
        [Command("rule add")]
        public SfResponse RuleAdd(ScannerRuleAddOptions options)
        {
        ...
        /// </remarks>
        /// <example>
        /// $ $ sf rule describe --rulename ExampleRule
        ...
        public SfResponse RuleDescribe(ScannerRuleDescribeOptions options)
        {
        ...
        /// 	$ $ sf rule list --language apex,javascript
        /// 
        ...
        /// 	$ $ sf rule list --category '!Design,!Best Practices'
        /// 
        ...
        /// 	$ $ sf rule list --language apex,javascript --ruleset Braces,Security
        /// </example>
        [Command("rule list")]
        public SfResponse RuleList(ScannerRuleListOptions options = null)
        {
        ...
        /// 	$ $ sf rule remove --path "~/path/to/somerules.jar,~/path/to/folder/containing/rules"
        /// 
        ...
        /// 	$ $ sf rule remove --force --path "~/path/to/somerules.jar"
        /// </example>
        [Command("rule remove")]
        public SfResponse RuleRemove(ScannerRuleRemoveOptions options = null)
        {
        ...
        /// 	$ $ sf run --format xml --target "somefile.js"
        /// 
        ...
        /// 	$ $ sf run --target "/my-project/** /*.ts" --tsconfig "/my-project/tsconfig.json"
        /// 
        ...
        /// 	$ $ sf run --target "somefile.js" --env '{"jasmine": true}'
        /// 
        ...
        /// 	$ $ sf run --target "somefile.js" --engine "eslint-lwc,pmd"
        /// 
        ...
        /// 	$ $ sf run --target "/some/dir" --engine cpd
        /// 
        ...
        /// 	$ $ sf run --target "src" --pmdconfig "pmd_rule_ref.xml"
        /// 
        ...
        /// 	$ $ sf run --target "src" --eslintconfig "/home/my/setup/.eslintrc.json"
        /// 
        ...
        /// 	$ $ sf run --target "/some-project/" --format csv --normalize-severity
        /// 
        ...
        /// 	$ $ sf run --target "/some-project/" --severity-threshold 2
        /// 
        /// The paths specified for --projectdir must contain all files specified through --target cumulatively.
        /// 	$ $ sf run --target "./myproject/main/default/classes/*.cls" --projectdir "./myproject/"
        /// 	$ $ sf run --target "./** /*.cls" --projectdir "./"
        /// 	$ $ sf run --target "./dir1/file1.cls,./dir2/file2.cls" --projectdir "./dir1/,./dir2/"
        /// 
        /// This example fails because the set of files included in --target is larger than that contained in --projectdir:
        /// 	$ $ sf run --target "./** /*.cls" --projectdir "./myproject/"
        /// </example>
        [Command("run")]
        public SfResponse Run(ScannerRunOptions options = null)
        {
        ...
        /// <example>
        /// The paths specified for --projectdir must contain all files specified through --target cumulatively.
        /// 	$ $ sf run dfa --target "./myproject/main/default/classes/*.cls" --projectdir "./myproject/"
        /// 	$ $ sf run dfa --target "./** /*.cls" --projectdir "./"
        /// 	$ $ sf run dfa --target "./dir1/file1.cls,./dir2/file2.cls" --projectdir "./dir1/,./dir2/"
        /// This example fails because the set of files included in --target is larger than that contained in --projectdir:
        /// 	$ $ sf run dfa --target "./** /*.cls" --projectdir "./myproject/"
        ...
        /// Unix example:
        /// 	$ $ sf run dfa --target "./** /*.cls,!./** /IgnoreMe.cls" ...
        /// Windows example:
        /// 	$ $ sf run dfa --target ".\**\*.cls,!.\**\IgnoreMe.cls" ...
        ...
        /// 	$ $ sf run dfa --target "./File1.cls#Method1;Method2,./File2.cls#Method3" ...
        ...
        /// 	$ $ sf run dfa --target "./some-project/" --projectdir "./some-project/" --format csv --normalize-severity
        ...
        /// 	$ $ sf run dfa --target "./some-project/" --projectdir "./some-project/" --severity-threshold 2
        /// use --rule-thread-count to allow more (or fewer) entrypoints to be evaluated concurrently:
        /// 	$ $ sf run dfa --rule-thread-count 6 ...
        ...
        /// 	$ $ sf run dfa --rule-thread-timeout 9000000 ...
        ...
        /// 	$ $ sf run dfa --sfgejvmargs "-Xmx8g" ...
        /// Use --with-pilot to allow execution of pilot rules:
        /// This example allows pilot rules in the "Performance" category to execute.
        /// 	$ $ sf run dfa --category 'Performance' --with-pilot ...
        /// </example>
        [Command("run dfa")]
        public SfResponse RunDfa(ScannerRunDfaOptions options = null)
        {
