...
namespace sfdx4csharpClient
{
    ...
    /// </summary>
    public class DevAuditMessagesOptions : SfdxOptions
    {
        /// <summary>
        ...
        /// <summary>
        /// [Required] No description for project-dir
        /// </summary>
        [SwitchName("--project-dir")]
        public string ProjectDir { get; set; }

        /// <summary>
        /// [Required] The default is the "messages" directory in the current working directory.
        /// </summary>
        [SwitchName("--messages-dir")]
        public string MessagesDir { get; set; }

        /// <summary>
        /// [Required] The default is the "src" directory in the current working directory.
        /// </summary>
    ...
    /// </summary>
    public class DevConvertMessagesOptions : SfdxOptions
    {
        /// <summary>
        /// [Required] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
    ...
    /// </summary>
    public class DevConvertScriptOptions : SfdxOptions
    {
        /// <summary>
        /// [Required] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
    ...
    /// </summary>
    public class DevGenerateCommandOptions : SfdxOptions
    {
        /// <summary>
        /// [Required] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
    ...
    /// </summary>
    public class DevGenerateFlagOptions : SfdxOptions
    {
        /// <summary>
        /// [Required] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
    ...
    /// </summary>
    public class DevGeneratePluginOptions : SfdxOptions
    {
        /// <summary>
        /// [Required] Raw string parameters for the command. EX: 'name=value' expressions or parameters without flags.
        /// </summary>
    ...
    public class Dev : SfdxCommand
    {
        ...
        public SfdxResponse AuditMessages(DevAuditMessagesOptions options)
        {
        ...
        public SfdxResponse ConvertMessages(DevConvertMessagesOptions options)
        {
        ...
        public SfdxResponse ConvertScript(DevConvertScriptOptions options)
        {
        ...
        public SfdxResponse GenerateCommand(DevGenerateCommandOptions options)
        {
        ...
        public SfdxResponse GenerateFlag(DevGenerateFlagOptions options)
        {
        ...
        public SfdxResponse GeneratePlugin(DevGeneratePluginOptions options)
        {
